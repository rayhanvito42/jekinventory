...
<html lang="ID-id">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo get_theme_uri('images/logo1.jpg'); ?>" class="brand-link">
      <img src="<?php echo get_theme_uri('images/logo1.jpg'); ?>" alt="<?php echo get_store_name(); ?> Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
