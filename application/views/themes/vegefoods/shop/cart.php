...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg11.jpg'); ?>');">
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
          ...
          <?php if ( count($carts) > 0) : ?>
            <form action="https://api.whatsapp.com/send?phone=6283835741435" method="POST">
              <div class="row">
          ...
          <div class="row justify-content-end">
              ...
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  ...
                  <a target='_BLANK' style='text-transform:uppercase; font-weight:bold' class='btn btn-success btn-sm' href='https://api.whatsapp.com/send?phone=6283835741435&text=Haloo%20saya%20mau%20order'>Order Via WhatsApp</a>              </div>
          </div>
          </form>
          <?php else : ?>
            <div class="row">
